/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fac39f127d0f6ab61526f44fae5c4a7f)
// Runtime types generated with workerd@1.20260911.1 2026-09-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	AI_GATEWAY_ID: "default";
	MAIL_ROUTER_URL: "https://peer-point-mail-router.peer-point-user-group.workers.dev";
	MAIL_ROUTER_CAPABILITY: "simulator-only";
	EMAIL_SIGNING_PUBLIC_JWK: "{\"key_ops\":[\"verify\"],\"ext\":true,\"kty\":\"EC\",\"x\":\"LatDY36vPPJ1_BzPUvSD0XOZRc9U6hq8WAlN5tkKhas\",\"y\":\"UYgIhQnGWF8YvWtF7g6OFoGsizva0ndqTPYdS_xqLAs\",\"crv\":\"P-256\"}";
	INBOX_HANDLE: "mtl-agent";
	INBOUND_DOMAIN: "cf.prompt2prod.dev";
	CITY: "Montreal";
	CARD: "inbox-agent";
	ENVIRONMENT: "starter";
	INBOX_AGENT: DurableObjectNamespace<import("./src/server").InboxAgent>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "MAIL_ROUTER_URL" | "MAIL_ROUTER_CAPABILITY" | "EMAIL_SIGNING_PUBLIC_JWK" | "INBOX_HANDLE" | "INBOUND_DOMAIN" | "CITY" | "CARD" | "ENVIRONMENT">> {}
}
